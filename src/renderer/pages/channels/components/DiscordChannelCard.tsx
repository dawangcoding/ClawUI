...
import type { DiscordStatus } from '../../../../shared/types/gateway-protocol'
...
export default function DiscordChannelCard(props: ChannelCardProps) {
   const { channelKey, label, description, accounts, channelStatus, loading, onRefresh, accent, letter, enabled } =
      props
   const status = channelStatus as DiscordStatus | null
