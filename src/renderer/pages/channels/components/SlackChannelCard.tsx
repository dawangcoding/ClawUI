...
import type { SlackStatus } from '../../../../shared/types/gateway-protocol'
...
export default function SlackChannelCard(props: ChannelCardProps) {
   const { channelKey, label, description, accounts, channelStatus, loading, onRefresh, accent, letter, enabled } =
      props
   const status = channelStatus as SlackStatus | null
